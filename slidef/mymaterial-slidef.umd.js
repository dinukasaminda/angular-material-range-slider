...
(function (global, factory) {
    ...
    var MATERIAL_COMPATIBILITY_MODE = new core.InjectionToken(
     ...
     */
    var MATERIAL_SANITY_CHECKS = new core.InjectionToken(
        "mat-sanity-checks"
    );
    /**
    ...
    var NativeDateAdapter = (function(_super) {
            ...
            if (SUPPORTS_INTL_API) {
                ...
                return range(12, function(i) {
                    return _this._stripDirectionalityCharacters(
                        dtf_1.format(new Date(2017, i, 1))
                    );
                });
            }
        ...
        NativeDateAdapter.prototype.getDateNames = function() {
            ...
            if (SUPPORTS_INTL_API) {
                ...
                return range(31, function(i) {
                    return _this._stripDirectionalityCharacters(
                        dtf_2.format(new Date(2017, 0, i + 1))
                    );
                });
            }
        ...
        NativeDateAdapter.prototype.getDayOfWeekNames = function(style) {
            ...
            if (SUPPORTS_INTL_API) {
                ...
                return range(7, function(i) {
                    return _this._stripDirectionalityCharacters(
                        dtf_3.format(new Date(2017, 0, i + 1))
                    );
                });
            }
        ...
        NativeDateAdapter.prototype.createDate = function(year, month, date) {
            ...
            var /** @type {?} */ result = this._createDateWithOverflow(
                year,
                month,
                date
            );
        ...
        NativeDateAdapter.prototype.format = function(date, displayFormat) {
            ...
            if (SUPPORTS_INTL_API) {
                ...
                var /** @type {?} */ dtf = new Intl.DateTimeFormat(
                    this.locale,
                    displayFormat
                );
                return this._stripDirectionalityCharacters(dtf.format(date));
         ...
         * @return {?}
         */
        NativeDateAdapter.prototype._createDateWithOverflow = function(
            year,
            month,
            date
        ) {
    ...
    var RippleRenderer = (function() {
        ...
        RippleRenderer.prototype.fadeInRipple = function(x, y, config) {
            ...
            var /** @type {?} */ duration =
                RIPPLE_FADE_IN_DURATION * (1 / (config.speedFactor || 1));
    ...
    function distanceToFurthestCorner(x, y, rect) {
        var /** @type {?} */ distX = Math.max(
            Math.abs(x - rect.left),
            Math.abs(x - rect.right)
        );
        var /** @type {?} */ distY = Math.max(
            Math.abs(y - rect.top),
     ...
     */
    var MAT_RIPPLE_GLOBAL_OPTIONS = new core.InjectionToken(
    ...
    var MatRipple = (function() {
        ...
        MatRipple.prototype.ngOnChanges = function(changes) {
            if (
                (changes["trigger"] || changes["_matRippleTrigger"]) &&
                this.trigger
            ) {
        ...
        MatRipple.prototype._updateRippleRenderer = function() {
            this._rippleRenderer.rippleDisabled =
                this._globalOptions.disabled || this.disabled;
        ...
        MatRipple.propDecorators = {
            ...
            speedFactor: [
                { type: core.Input, args: ["matRippleSpeedFactor"] }
            ],
    ...
    var MatOption = (function() {
         ...
         * @return {?}
         */
        MatOption.countGroupLabelsBeforeOption = function(
            optionIndex,
            options,
            optionGroups
        ) {
     ...
     */
    var MAT_PLACEHOLDER_GLOBAL_OPTIONS = new core.InjectionToken(
        "mat-placeholder-global-options"
    );
    ...
    var MatSlidef = (function(_super) {
        ...
        Object.defineProperty(MatSlidef.prototype, "value", {
            ...
            set: function(v) {
                if (v !== this._value) {
                    this._value = coercion.coerceNumberProperty(
                        v,
                        this._value || 0
                    );
                    if (this.values != null) {
        ...
        Object.defineProperty(MatSlidef.prototype, "value2", {
            ...
            set: function(v) {
                if (v !== this._value2) {
                    this._value2 = coercion.coerceNumberProperty(
                        v,
                        this._value2 || 0
                    );
                    if (this.values != null) {
        ...
        function fraction1(val) {
            if (val.length > 3) {
                return fraction1(val.substring(0, val.length - 3)) + "," + val.substring(val.length - 3, val.length)
            } else {
                return val
            }
        }
        ...
        function fraction2(val) {
            ...
            var rslt = val;
            if (ln > 7) {
                rslt = val.substr(0, ln - 7) + "," + val.substr(ln - 7, 2) + "," + val.substr(ln - 5, 2) + "," + val.substring(ln - 3);
            } else if (ln > 5) {
        ...
        Object.defineProperty(MatSlidef.prototype, "_thumbContainerStyles", {
            ...
            get: function() {
                ...
                var /** @type {?} */ invertOffset =
                    this._direction == "rtl" && !this.vertical ?
                    !this._invertAxis :
                    this._invertAxis;
                var /** @type {?} */ offset =
                    (invertOffset ? this.percent : 1 - this.percent) * 100;
                return {
        ...
        Object.defineProperty(MatSlidef.prototype, "_thumbContainerStyles2", {
            ...
            get: function() {
                ...
                var /** @type {?} */ invertOffset =
                    ...
                    this._invertAxis;
                var /** @type {?} */ offset =
                    (invertOffset ? this.percent2 : 1 - this.percent2) * 100;
        ...
        Object.defineProperty(MatSlidef.prototype, "_invertMouseCoords", {
             ...
             */
            get: function() {
                return this._direction == "rtl" && !this.vertical ?
                    !this._invertAxis :
                    this._invertAxis;
            },
            enumerable: true,
        ...
        MatSlidef.prototype._updateValueFromPosition = function(pos) {
            ...
            var /** @type {?} */ percent = this._clamp(
                (posComponent - offset) / size
            );
            ...
            if (
                getModulus(closestValue - this.value) <
                getModulus(closestValue - this.value2)
            ) {
        ...
        MatSlidef.prototype._updateTickIntervalPercent = function() {
            ...
            if (this.tickInterval == "auto") {
                var /** @type {?} */ trackSize = this.vertical ?
                    this._slidefDimensions.height :
                    this._slidefDimensions.width;
                var /** @type {?} */ pixelsPerStep =
                    trackSize * this.step / (this.max - this.min);
                var /** @type {?} */ stepsPerTick = Math.ceil(
                    MIN_AUTO_TICK_SEPARATION / pixelsPerStep
                );
        ...
        MatSlidef.prototype._getSlidefDimensions = function() {
            return this._slidefWrapper ?
                this._slidefWrapper.nativeElement.getBoundingClientRect() :
                null;
        };
        /**
        ...
        MatSlidef.propDecorators = {
            ...
            _thumbLabelDeprecated: [
                { type: core.Input, args: ["thumb-label"] }
            ],
            tickInterval: [{ type: core.Input }],
            _tickIntervalDeprecated: [
                { type: core.Input, args: ["tick-interval"] }
            ],
            value: [{ type: core.Input }],
            ...
            _slidefWrapper: [
                { type: core.ViewChild, args: ["slidefWrapper"] }
            ]
        };
        return MatSlidef;
    })(_MatSlidefMixinBase);
